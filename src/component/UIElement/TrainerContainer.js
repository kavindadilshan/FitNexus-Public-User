...
import { View, StyleSheet, Image, Text, TouchableOpacity, Dimensions, ActivityIndicator } from 'react-native';
    ...
    render() {
        return (
            <TouchableOpacity style={{ width: 160, marginBottom: 20 }}
                onPress={this.props.onPress} disabled={this.props.onPress==='disabled'}>
